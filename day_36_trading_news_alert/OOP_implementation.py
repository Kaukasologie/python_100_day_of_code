# from: https://www.udemy.com/course/100-days-of-code/learn/lecture/21377474#questions/14947286
...
if abs(percentage_change) >= 5:
    ...
    message = "%s: %s%s%%\n%s" % (STOCK, "🔺" if percentage_change > 0 else "🔻" if percentage_change < 0 else "➖",
                                  percentage_change, '\n'.join(news_headlines))
